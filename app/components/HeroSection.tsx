  ...
  return (
    <section className="w-full full-dvh flex items-center justify-center px-4 mt-2 sm:mt-4 md:mt-6 lg:mt-8">
      <motion.div
        ...
        className="relative rounded-3xl border-2 border-[#00FF41] bg-[radial-gradient(600px_400px_at_0%_0%,#00FF41_0%,rgba(0,143,17,0.7)_40%,rgba(13,2,8,0.92)_70%),radial-gradient(600px_400px_at_100%_100%,#00FF41_0%,rgba(0,143,17,0.7)_40%,rgba(13,2,8,0.92)_70%)] backdrop-blur-md shadow-[0_0_32px_#00FF41,0_0_0_4px_#00FF41] flex items-center justify-center w-full max-w-[1200px] min-h-[60dvh] sm:min-h-[70dvh] md:min-h-[75dvh] lg:min-h-[80dvh] p-4 sm:p-6 overflow-hidden"
      >
